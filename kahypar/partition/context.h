...
#include "kahypar/utils/stats2.h"
namespace kahypar {
...
class Context {
 public:
  using PartitioningStats = Stats2<Context>;
  ...
  Context(const Configuration &config) : 
    ...
    stats(*this) {preprocessing.louvain_community_detection.edge_weight = LouvainEdgeWeight::uniform;}
